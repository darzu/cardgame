    ...
    export var m = function m() { return hyperscript.apply(this, arguments); };
    m.m = hyperscript;
    export var trust = hyperscript.trust;
    export var fragment = hyperscript.fragment;
    export var mount = mountRedraw.mount;
    var m3 = hyperscript;
    ...
    export var route = _25(window, mountRedraw);
    export var render = render;
    export var redraw = mountRedraw.redraw;
    export var request = request.request;
    export var jsonp = request.jsonp;
    export var parseQueryString = parseQueryString;
    export var buildQueryString = buildQueryString;
    export var parsePathname = parsePathname;
    export var buildPathname = buildPathname;
    export var vnode = Vnode;
    export var PromisePolyfill = PromisePolyfill;
